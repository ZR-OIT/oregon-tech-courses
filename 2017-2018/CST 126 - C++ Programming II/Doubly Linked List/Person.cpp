...
{
	cout << left << setw(12) << m_lname << setw(12) << m_fname << setw(32) << m_email << setw(25)
			<< m_street << setw(16) << m_city << setw(16) << m_state << setw(6) << m_zip << endl;
}
...
{
	int compare = strcmp(GetLName(), lname);

	if (compare == 0)
	{
		compare = strcmp(GetFName(), fname);
	}
